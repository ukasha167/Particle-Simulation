...
public:
    ...
    static std::array<int16_t, TOTAL_CELLS> gridStart;                  // SIGNED BECAUSE IT CAN STORE NEGATIVE VALUES
    ...
    static std::array<uint16_t, TOTAL_PARTICLES_COUNT> sortedParticleIndices;
...
private:
    ...
    static void defineParticlesInitialParameters();
    ...
    static void sortParticlesByCell();
};
